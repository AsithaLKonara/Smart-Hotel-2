...
* [x] Missing composite indexes: Tables like `Payment` and `Booking` lack specific composite indexes for complex analytical dashboard queries.
...
* [x] Missing CSRF/SSRF protections on internal admin API requests.
