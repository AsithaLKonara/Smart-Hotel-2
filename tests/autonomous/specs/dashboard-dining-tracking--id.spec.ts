...
test.describe('Autonomous Coverage: /dashboard/dining/tracking/[id]', () => {
  test('should load without critical errors as UNAUTHENTICATED', async ({ page, loginAs }) => {
    ...
    const response = await page.goto('/dashboard/dining/tracking/mock-id-123', { waitUntil: 'domcontentloaded' });
