...
test.describe('Autonomous Coverage: /admin/maintenance/inspections', () => {
  test('should load without critical errors as UNAUTHENTICATED', async ({ page, loginAs }) => {
    ...
    const response = await page.goto('/admin/maintenance/inspections', { waitUntil: 'domcontentloaded' });
