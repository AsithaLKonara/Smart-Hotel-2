...
test.describe('Autonomous Coverage: /admin/dashboard/checkin-checkout', () => {
  test('should load without critical errors as UNAUTHENTICATED', async ({ page, loginAs }) => {
    ...
    const response = await page.goto('/admin/dashboard/checkin-checkout', { waitUntil: 'domcontentloaded' });
