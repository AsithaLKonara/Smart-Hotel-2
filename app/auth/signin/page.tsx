...
export default function SignInPage() {
 ...
 { role: 'Kitchen & F&B', email: 'kitchen@smarthotel.com', password: 'SmartHotel@2025!Kitchen', color: 'from-rose-500/20 to-pink-500/20 border-border text-rose-200' },
 ...
 className="w-full max-w-6xl bg-white/[0.03] backdrop-blur-3xl border border-border rounded-[48px] overflow-hidden shadow-[0_32px_120px_-15px_rgba(0,0,0,0.9)] flex flex-col lg:flex-row"
 >
 ...
 <span className="text-xs font-bold text-primary/60">Simulator Access</span>
 </div>
 ...
 className={`group relative px-4 py-3 rounded-lg border transition-all hover:scale-[1.02] active:scale-95 bg-gradient-to-br ${cred.color} overflow-hidden`}
 >
 <div className="relative z-10 flex flex-col items-start">
 <span className="text-xs font-bold opacity-60">Role</span>
 ...
 {/* Bottom Accent */}
 <div className="mt-12 lg:mt-0 flex items-center space-x-4 text-muted-foreground">
 <ShieldCheck className="w-5 h-5" />
 <span className="text-xs font-bold">Encrypted Quantum Layer Access</span>
 </div>
 </div>

 {/* Right Side: Authentication Form */}
 <div className="lg:w-7/12 p-10 lg:p-16 bg-muted/50 backdrop-blur-xl border-l border-border">
 <div className="max-w-md mx-auto space-y-10">
 <div className="space-y-2">
 <h2 className="text-3xl font-serif font-bold text-white">Sign In</h2>
 <p className="text-muted-foreground text-sm">Enter your sanctuary credentials or use social access.</p>
 </div>
 ...
 className="flex items-center justify-center space-x-3 py-4 px-4 border border-border rounded-lg bg-muted/50 hover:bg-white/10 transition-all hover:border-white/20 group"
 >
 ...
 <div className="relative flex justify-center text-xs "><span className="bg-transparent px-4 text-muted-foreground font-bold">Universal Security Gate</span></div>
 </div>

 <form onSubmit={handleSubmit} className="space-y-6">
 <div className="space-y-4">
 <div className="group space-y-1">
 <label className="text-xs font-bold text-muted-foreground ml-2 group-focus-within:text-primary transition-colors">Staff Email</label>
 <input 
 type="email" 
 required
 className="w-full bg-muted/50 border border-border text-white placeholder:text-muted-foreground px-6 py-5 rounded-lg text-sm focus:ring-1 focus:ring-primary focus:bg-white/10 transition-all outline-none"
 ...
 <label className="text-xs font-bold text-muted-foreground group-focus-within:text-primary transition-colors">Access Key</label>
 <Link href="/auth/forgot-password" virtual-link="true" className="text-xs text-primary/60 font-bold hover:text-primary transition-colors">Reset Key?</Link>
 </div>
 <div className="relative">
 <input 
 ...
 type="submit" 
 disabled={isLoading}
 className="w-full bg-primary hover:bg-primary/90 text-white h-16 rounded-lg text-xs font-bold group transition-all shadow-[0_10px_30px_-10px_rgba(var(--primary-rgb),0.5)]"
 >
 {isLoading ? (
