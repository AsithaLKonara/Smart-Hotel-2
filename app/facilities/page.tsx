...
export default function FacilitiesPage() {
 ...
 <span className="text-luxury text-xs font-bold">{facility.subtitle}</span>
 </div>
 ...
 <Button variant="outline" className="border-white/20 text-white rounded-xl px-10 h-14 text-xs font-bold hover:bg-white/10 transition-all group">
 ...
 {/* Quick Services */}
 <section className="py-24 bg-black/25 backdrop-blur-sm border-t border-border">
 <div className="container mx-auto px-4">
 ...
 <div className="w-20 h-20 bg-muted/50 border border-border backdrop-blur-md flex items-center justify-center mx-auto text-primary rounded-lg">
