...
function GoogleMapFallback({ lat, lng, address }: { lat: number; lng: number; address: string }) {
 ...
 className="text-xs font-bold text-luxury hover:underline"
 >
 View on Google Maps
 </a>
 </div>
...
function FAQSection() {
 ...
 <h4 className="text-primary text-xs font-bold">Common Inquiries</h4>
...
export default function ContactPage() {
 ...
 <label htmlFor="contactName" className="text-xs font-bold text-muted-foreground">Full Name</label>
 <input 
 id="contactName"
 type="text" 
 className="w-full bg-muted/50 border border-border text-white placeholder:text-muted-foreground px-6 py-4 focus:ring-1 focus:ring-primary transition-all text-sm rounded-xl"
 value={formData.name}
 ...
 <div className="space-y-2">
 <label htmlFor="contactEmail" className="text-xs font-bold text-muted-foreground">Email Address</label>
 <input 
 id="contactEmail"
 type="email" 
 className="w-full bg-muted/50 border border-border text-white placeholder:text-muted-foreground px-6 py-4 focus:ring-1 focus:ring-primary transition-all text-sm rounded-xl"
 ...
 <div className="space-y-2">
 <label htmlFor="contactSubject" className="text-xs font-bold text-muted-foreground">Subject</label>
 <input 
 id="contactSubject"
 type="text" 
 className="w-full bg-muted/50 border border-border text-white placeholder:text-muted-foreground px-6 py-4 focus:ring-1 focus:ring-primary transition-all text-sm rounded-xl"
 ...
 <div className="space-y-2">
 <label htmlFor="contactMessage" className="text-xs font-bold text-muted-foreground">Message</label>
 <textarea 
 id="contactMessage"
 rows={6}
 className="w-full bg-muted/50 border border-border text-white placeholder:text-muted-foreground px-6 py-4 focus:ring-1 focus:ring-primary transition-all text-sm rounded-xl resize-none"
 ...
 className="bg-primary/10 text-white rounded-none px-12 h-16 tracking-[0.2em] text-xs font-bold border-none shadow-sm w-full md:w-auto"
 >
 {isSubmitting ? 'Sending...' : 'Transmit Message'}
 </Button>

 {submitStatus === 'success' && <p className="text-green-600 text-xs font-bold ">Message sent successfully.</p>}
 </form>
 </div>
 ...
 <div key={i} className="flex items-start gap-6 p-6 bg-muted/50 backdrop-blur-md border border-border hover:border-primary/30 transition-all duration-500 group rounded-lg">
 ...
 <div className="space-y-2">
 <h3 className="text-xs font-bold text-muted-foreground">{item.title}</h3>
 ...
 <div className="relative aspect-video shadow-sm overflow-hidden rounded-lg border border-border">
 <GoogleMapFallback 
