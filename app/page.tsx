      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Welcome to Grand Palace Hotel</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Located in the heart of the city, Grand Palace Hotel offers an exceptional blend of 
              luxury, comfort, and world-class service. Our hotel features elegant accommodations, 
              award-winning dining, and state-of-the-art facilities.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg">
              <div className="h-64 bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
                <span className="text-white text-lg font-medium">Standard Room</span>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">Standard Room</h3>
                <p className="text-gray-600 mb-4">Comfortable and elegant accommodation with city views.</p>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg">
              <div className="h-64 bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center">
                <span className="text-white text-lg font-medium">Deluxe Room</span>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">Deluxe Room</h3>
                <p className="text-gray-600 mb-4">Spacious rooms with premium amenities and balcony access.</p>
                <div className="flex items-center justify-between">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg">
              <div className="h-64 bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center">
                <span className="text-white text-lg font-medium">Presidential Suite</span>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">Presidential Suite</h3>
                <p className="text-gray-600 mb-4">Ultimate luxury with separate living area and premium services.</p>
                <div className="flex items-center justify-between">
