...
export default function SpaPage() {
 ...
 <div className="flex items-center justify-center space-x-3 text-luxury tracking-[0.4em] text-xs font-bold">
 ...
 <h4 className="text-luxury text-xs font-bold">The Serenity Method</h4>
 ...
 <Button variant="outline" className="border-white/20 text-white rounded-none px-10 h-14 text-xs font-bold hover:bg-white/10 transition-all">
 Download Spa Menu
 </Button>
 </motion.div>
 </div>
 ...
 <h4 className="text-luxury text-xs font-bold">Signature Rituals</h4>
 ...
 <div key={treatment.id} className="group bg-muted/50 border border-border overflow-hidden shadow-sm hover:-translate-y-2 transition-all duration-500 rounded-lg">
 ...
 <p className="text-xs tracking-[0.2em] text-luxury font-bold">{treatment.subtitle}</p>
 ...
 <Link href="/contact" className="text-luxury text-xs font-bold flex items-center group-hover:translate-x-1 transition-transform">
 <span>Book Now</span>
 ...
 {/* Amenities Icons */}
 <section className="py-24 bg-transparent text-white border-t border-border">
 <div className="container mx-auto px-4">
 ...
 <div className="w-16 h-16 bg-muted/50 border border-border flex items-center justify-center mx-auto text-luxury">
 <item.icon className="w-8 h-8" />
 </div>
 <h3 className="text-lg font-serif font-bold">{item.title}</h3>
 <p className="text-muted-foreground text-xs font-light tracking-wide">{item.desc}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <Link href="/contact">
 <Button className="bg-primary/10 hover:opacity-90 text-white px-12 h-16 rounded-none text-xs tracking-[0.2em] font-bold border-none shadow-sm w-full sm:w-auto">
 Book Treatment
 </Button>
 </Link>
 <Link href="/contact">
 <Button variant="outline" className="border-white text-white rounded-none px-12 h-16 tracking-[0.2em] text-xs font-bold hover:bg-white hover:text-midnight transition-all w-full sm:w-auto">
