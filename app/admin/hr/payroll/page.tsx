...
export default function PayrollPage() {
 ...
 <p className="text-muted-foreground">Process global salaries and itemized payslips</p>
 </div>
 ...
 <input type="date" required value={formData.periodStart} onChange={e=>setFormData({...formData, periodStart: e.target.value})} className="w-full p-2 rounded bg-black/50 border border-border mt-1" />
 </div>
 <div>
 <label className="text-xs text-muted-foreground">Period End Date</label>
 <input type="date" required value={formData.periodEnd} onChange={e=>setFormData({...formData, periodEnd: e.target.value})} className="w-full p-2 rounded bg-black/50 border border-border mt-1" />
 </div>
 </div>
 ...
 <th className="p-4 font-medium text-muted-foreground">Period</th>
 <th className="p-4 font-medium text-muted-foreground text-right">Base</th>
 <th className="p-4 font-medium text-muted-foreground text-right">Additions</th>
 <th className="p-4 font-medium text-muted-foreground text-right">Deductions</th>
 ...
 <div className="text-xs text-muted-foreground">{run.lineItems?.length || 0} Employees Paid</div>
 </div>
 </td>
 ...
 <div className="p-12 text-center text-muted-foreground">No payroll records found.</div>
 )}
 </div>
 </div>
 )
