...
export default function NightAuditDashboard() {
 ...
 <p className="text-muted-foreground mt-2 text-lg">Finalize daily revenue and advance the property business date.</p>
 </div>
 </div>
 ...
 <CardContent>
 <div className="text-5xl font-bold font-mono text-indigo-950">
 {status?.businessDate}
 </div>
 </CardContent>
 </Card>
 ...
 <span className="font-mono text-sm text-muted-foreground">{result.previousDate}</span>
