...
export default function OrganizationDashboard() {
 ...
 <span className="text-xs tracking-[0.25em] text-[#D4AF37] font-medium">Enterprise Group Overview</span>
 ...
 className="px-5 py-2.5 rounded-xl text-xs font-semibold tracking-wider bg-gradient-to-r from-[#D4AF37] to-[#9C8259] text-[#09050D] hover:opacity-95 active:scale-[0.98] transition-all disabled:opacity-50"
 >
 ...
 ? 'bg-emerald-500/10 border-border text-emerald-400' 
 : 'bg-muted/50 border-white/[0.04] text-[#8E8C94]'
 }`}
 >
 {exportMessage}
 </motion.div>
 ...
 <div className="bg-[#121118]/85 border border-white/[0.04] rounded-lg p-6">
 <span className="text-xs tracking-wider text-[#8E8C94] block">Consolidated Revenue</span>
 ...
 <div className="bg-[#121118]/85 border border-white/[0.04] rounded-lg p-6">
 <span className="text-xs tracking-wider text-[#8E8C94] block">Average Occupancy</span>
 <span className="text-3xl font-light font-serif text-white mt-2 block">
 {averageOccupancy}%
 </span>
 ...
 <div className="bg-[#121118]/85 border border-white/[0.04] rounded-lg p-6">
 <span className="text-xs tracking-wider text-[#8E8C94] block">Chain Wide ADR</span>
 <span className="text-3xl font-light font-serif text-white mt-2 block">
 ${averageADR}
 </span>
 ...
 <div className="text-xs text-[#8E8C94] mt-0.5">{prop.location}</div>
 </td>
 ...
 prop.slaBreachRatio < 1.0 ? 'bg-emerald-500/10 text-emerald-400 border border-border' :
 'bg-amber-500/10 text-amber-400 border border-border'
 }`}>
 {prop.slaBreachRatio}%
 </span>
 </td>
 ...
 <div className="lg:col-span-4 bg-[#121118]/85 border border-white/[0.04] rounded-lg p-6 space-y-6">
 <h2 className="text-lg font-serif font-light text-white tracking-wider">
 ...
 <div className="p-4 rounded-xl bg-muted/50 border border-white/[0.04] space-y-2">
 <div className="flex justify-between items-center">
 <span className="text-xs font-semibold text-white">SOC-2 Type II Compliance</span>
 <span className="text-xs bg-emerald-500/10 text-emerald-400 px-1.5 py-0.5 rounded font-mono font-bold">ACTIVE</span>
 </div>
 ...
 <span className="text-xs bg-emerald-500/10 text-emerald-400 px-1.5 py-0.5 rounded font-mono font-bold">CERTIFIED</span>
 </div>
 <p className="text-[11px] text-[#8E8C94]">
 ...
 <span className="text-xs text-[#D4AF37] px-1.5 py-0.5 rounded font-mono font-bold">99.99%</span>
 </div>
