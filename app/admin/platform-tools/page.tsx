...
export default function PlatformToolsPage() {
 ...
 <span className="text-xs tracking-[0.25em] text-[#D4AF37] font-medium">SRE Operational Dashboard</span>
 ...
 <span className="text-xs text-[#8E8C94] tracking-wider block">Active Locks</span>
 <span className="text-xl font-bold font-mono text-[#D4AF37]">{activeLocks.length}</span>
 </div>
 <div className="bg-[#121118] border border-white/[0.04] rounded-xl px-4 py-3 text-center">
 <span className="text-xs text-[#8E8C94] tracking-wider block">Failed Events</span>
 ...
 <div className="bg-[#121118]/85 border border-white/[0.04] rounded-lg p-6 space-y-4">
 ...
 evt.status === 'DISPATCHED' ? 'bg-emerald-500/10 text-emerald-400 border border-border' :
 evt.status === 'PENDING' ? 'bg-amber-500/10 text-amber-400 border border-border' :
 ...
 className="w-full py-3 rounded-xl font-semibold text-xs tracking-wider bg-gradient-to-r from-[#D4AF37] to-[#9C8259] text-[#09050D] hover:opacity-90 active:scale-[0.98] transition-all disabled:opacity-50"
 >
 ...
 <div className="bg-black/40 border border-white/[0.02] rounded-lg p-6 space-y-3 min-h-[250px] flex flex-col justify-between">
 <div className="space-y-2">
 <span className="text-xs tracking-wider text-[#8E8C94] font-medium block border-b border-white/[0.04] pb-2">
 Console Output
 </span>
 ...
 className="text-xs font-mono text-[#D4AF37] hover:underline self-start mt-2"
 >
 Clear logs
 </button>
 )}
