...
export default function AdminSettingsPage() {
 ...
 <CardDescription className="text-muted-foreground text-xs font-bold mt-1">Core property credentials</CardDescription>
 </div>
 ...
 <label className="text-xs font-bold text-muted-foreground ml-1">Property Name</label>
 <Input 
 value={formData.hotel_name} 
 onChange={(e) => handleChange('hotel_name', e.target.value)}
 required
 className="bg-muted/50 border-border rounded-lg h-14 focus:border-primary/50 transition-all"
 />
 </div>
 <div className="space-y-2">
 <label className="text-xs font-bold text-muted-foreground ml-1">Signature Tagline</label>
 <Input 
 ...
 <div className="space-y-2">
 <label className="text-xs font-bold text-muted-foreground ml-1">Brand Narrative</label>
 <Textarea 
 value={formData.hotel_description} 
 onChange={(e) => handleChange('hotel_description', e.target.value)}
 required
 rows={4}
 className="bg-muted/50 border-border rounded-xl p-6 focus:border-primary/50 transition-all resize-none"
 />
 </div>
 </CardContent>
 </Card>
 ...
 required
 className="bg-muted/50 border-border rounded-lg h-12 pl-12"
 />
 </div>
 </div>
 <div className="space-y-2">
 <label className="text-xs font-bold text-muted-foreground ml-1">Concierge Line</label>
 <div className="relative">
 ...
 <div className="space-y-2">
 <label className="text-xs font-bold text-muted-foreground ml-1">Physical Address</label>
 <div className="relative">
 ...
 required
 rows={2}
 className="bg-muted/50 border-border rounded-lg pl-12 pt-3"
 />
 </div>
 </div>
 <div className="grid grid-cols-2 gap-4 mt-4">
 <div className="space-y-2">
 <label className="text-xs font-bold text-muted-foreground ml-1">Latitude</label>
 <Input 
 value={formData.hotel_latitude} 
 onChange={(e) => handleChange('hotel_latitude', e.target.value)}
 className="bg-muted/50 border-border rounded-lg h-12"
 />
 </div>
 <div className="space-y-2">
 <label className="text-xs font-bold text-muted-foreground ml-1">Longitude</label>
 <Input 
 ...
 <div className="space-y-2">
 <label className="text-xs font-bold text-muted-foreground ml-1">Check-in</label>
 <Input 
 type="time"
 value={formData.check_in_time} 
 onChange={(e) => handleChange('check_in_time', e.target.value)}
 className="bg-muted/50 border-border rounded-lg h-12 text-center font-bold"
 />
 </div>
 <div className="space-y-2">
 <label className="text-xs font-bold text-muted-foreground ml-1">Check-out</label>
 <Input 
 type="time"
 ...
 <div className="p-6 bg-muted/50 border border-border rounded-[32px] space-y-4">
 <div className="flex items-center gap-3">
 <ShieldCheck className="w-5 h-5 text-primary" />
 <p className="text-xs text-white font-bold ">Global Sync Status</p>
 </div>
 ...
 <label className="text-xs font-bold text-muted-foreground ml-1">Founded Year</label>
 <Input 
 ...
 <label className="text-xs font-bold text-muted-foreground ml-1">The Story So Far</label>
 <Textarea 
 value={formData.hotel_story} 
 onChange={(e) => handleChange('hotel_story', e.target.value)}
 rows={3}
 className="bg-muted/50 border-border rounded-lg focus:border-primary/50 transition-all resize-none"
 />
 </div>
 </div>
 <div className="space-y-2 mt-2">
 <label className="text-xs font-bold text-muted-foreground ml-1">Milestones (One per line)</label>
 <Textarea 
 ...
 type="submit" 
 disabled={saving}
 className="h-16 px-12 bg-primary/10 text-white rounded-lg font-bold text-xs border-none shadow-sm min-w-[240px]"
 >
