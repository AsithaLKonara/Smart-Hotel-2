...
export default function StaffDirectoryPage() {
 ...
 <p className="text-muted-foreground mt-2">Manage employee roles and view the enterprise permission matrix.</p>
 </div>
 ...
 <div className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-slate-100 text-muted-foreground">
 <X className="w-4 h-4" />
 </div>
 )}
 </td>
