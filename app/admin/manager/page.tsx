...
export default function ManagerOperationsCenter() {
 ...
 <p className="text-muted-foreground text-sm mt-1">Operational oversight and high-level performance tracking.</p>
 </div>
 <Button onClick={loadAnalytics} variant="outline" className="bg-muted/50 border-border mt-4 md:mt-0">
 ...
 <div>
 <p className="text-xs text-muted-foreground font-bold ">Revenue Today</p>
 ...
 <div className="flex justify-between items-center">
 <div>
 <p className="text-xs text-muted-foreground font-bold ">Occupancy</p>
 ...
 <Card
 className="bg-muted/50 border-border p-6 cursor-pointer hover:bg-white/[0.04] transition-colors"
 onClick={() => router.push('/admin/staff')}
 >
 <div className="flex justify-between items-center">
 <div>
 <p className="text-xs text-muted-foreground font-bold ">Active Staff</p>
 ...
 <div
 key={complaint.id}
 className="p-4 bg-muted/50 border border-border rounded-xl hover:bg-white/[0.07] transition-colors"
 >
 <div className="flex justify-between items-start gap-3">
 <div className="min-w-0">
 <h5 className="text-sm font-bold truncate">
 {complaint.subject}
 {roomLabel && <span className="text-muted-foreground font-normal">{roomLabel}</span>}
 </h5>
 ...
 <p className="text-xs text-muted-foreground mt-1.5 line-clamp-2">{complaint.description}</p>
 )}
 </div>
 <Button
 size="sm"
 className={`h-7 text-xs shrink-0 ${cfg.color}`}
 ...
 variant="ghost"
 size="sm"
 className="w-full text-muted-foreground hover:text-white mt-1"
 onClick={() => router.push('/admin/complaints')}
 >
 View All Complaints
 </Button>
 ...
 <Button variant="outline" className="h-12 border-border hover:bg-white/10" onClick={() => router.push('/admin/rooms')}>Room Management</Button>
 <Button variant="outline" className="h-12 border-border hover:bg-white/10" onClick={() => router.push('/admin/inventory')}>Inventory Control</Button>
 <Button variant="outline" className="h-12 border-border hover:bg-white/10" onClick={() => router.push('/admin/analytics')}>Full Analytics</Button>
 <Button variant="outline" className="h-12 border-border hover:bg-white/10" onClick={() => router.push('/admin/settings')}>Resort Settings</Button>
 </div>
 </Card>
 </div>
 </div>
