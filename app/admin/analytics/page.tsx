...
export default function AdminAnalyticsPage() {
 ...
 }, [session, status, range]) // eslint-disable-line react-hooks/exhaustive-deps
 ...
 className="bg-[#1a1a1a] border border-border text-white p-2 rounded-lg"
 >
 ...
 <Button onClick={() => handleExport('pdf')} variant="outline" className="bg-[#1a1a1a] border-border text-white hover:bg-muted/50">
 <FileText className="w-4 h-4 mr-2 text-red-400" /> Export PDF
 </Button>
 <Button onClick={() => handleExport('excel')} variant="outline" className="bg-[#1a1a1a] border-border text-white hover:bg-muted/50">
