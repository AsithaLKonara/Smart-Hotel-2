...
export default function EnterpriseBIDashboard() {
 ...
 <div>
 <p className="text-blue-400 text-sm font-bold tracking-wider mb-1">Total Rooms Rev</p>
 <h2 className="text-3xl font-bold text-white">{formatCurrency(data.revenue.totalRoomsRevenue)}</h2>
 </div>
 ...
 <div className="flex justify-between items-start">
 <div>
 <p className="text-orange-400 text-sm font-bold tracking-wider mb-1">F&B / POS Rev</p>
 <h2 className="text-3xl font-bold text-white">{formatCurrency(data.revenue.totalPOSRevenue)}</h2>
 </div>
 ...
 <div className="flex justify-between items-start">
 <div>
 <p className="text-emerald-400 text-sm font-bold tracking-wider mb-1">MICE & Events</p>
 <h2 className="text-3xl font-bold text-white">{formatCurrency(data.revenue.totalEventsRevenue)}</h2>
 </div>
 ...
 <div className="flex justify-between items-start">
 <div>
 <p className="text-purple-400 text-sm font-bold tracking-wider mb-1">Points Liability</p>
 <h2 className="text-3xl font-bold text-white">{formatCurrency(data.loyalty.pointsLiabilityValue)}</h2>
 </div>
 ...
 ></div>
 <div className="text-xs text-muted-foreground mt-3">{data.trends.labels[i]}</div>
 </div>
 )
 })}
 </div>
 ...
 <span className="text-muted-foreground">Guest Satisfaction</span>
 ...
 <div>
 <div className="text-3xl font-bold text-white">{data.operations.activeEmployees}</div>
 <div className="text-xs text-muted-foreground tracking-wider mt-1">Active Staff</div>
 </div>
 <div>
 <div className="text-3xl font-bold text-white">{data.operations.openMaintenanceTickets}</div>
 <div className="text-xs text-muted-foreground tracking-wider mt-1">Open Tickets</div>
 </div>
 </div>

 <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
 <div>
 <div className="text-3xl font-bold text-white">{data.operations.avgHousekeepingTurnaroundMins}<span className="text-sm">m</span></div>
 <div className="text-xs text-muted-foreground tracking-wider mt-1">Avg Turnaround</div>
 </div>
 <div>
 <div className="text-3xl font-bold text-white">{data.loyalty.platinumCount}</div>
 <div className="text-xs text-muted-foreground tracking-wider mt-1">Platinum VIPs</div>
 </div>
 </div>
 </div>
 </CardContent>
