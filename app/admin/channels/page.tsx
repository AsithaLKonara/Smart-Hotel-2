...
export default function ChannelManagerDashboard() {
 ...
 <p className="text-muted-foreground mt-2">Manage OTA mappings and monitor real-time webhook syncs.</p>
 </div>
 <Button 
 ...
 <p className="text-xs text-muted-foreground font-mono mt-1 blur-[2px] hover:blur-none transition-all">
 {channel.apiKey}
 </p>
 </div>
 </div>
 ...
 <p className="text-sm text-muted-foreground text-center">No channels connected.</p>
 )}
 </CardContent>
 </Card>
 </div>
 ...
 <div className="text-xs font-semibold text-muted-foreground mb-1">External Channel</div>
 <div className="font-mono font-bold text-slate-800">{mapping.otaRoomTypeId}</div>
 <div className="text-xs text-muted-foreground mt-1">Rate: {mapping.otaRatePlanId || 'Standard'}</div>
 </div>
 ...
 <div className="text-xs font-semibold text-indigo-500 mb-1">SmartHotel PMS</div>
