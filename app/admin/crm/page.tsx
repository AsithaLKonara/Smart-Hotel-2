...
export default function CRMDashboard() {
 ...
 <p className="text-muted-foreground mt-1">Unified profiles, loyalty status, and history.</p>
 </div>
 ...
 <Star className={`w-3 h-3 mr-1 ${guest.loyalty?.tier === 'PLATINUM' ? 'text-purple-500' : 'text-muted-foreground'}`} />
