...
export default function AdminRoomTypesPage() {
 ...
 <p className="text-muted-foreground mt-1">Manage global configurations and pricing for room classes.</p>
 </div>
 ...
 <Card className="bg-[#0f0f13] border-border shadow-sm mb-6">
 ...
 className="w-full pl-9 pr-4 py-2 bg-black/40 border border-border rounded-lg text-white placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/50 transition-all text-sm"
 />
 </div>
 </div>
 ...
 <thead className="text-xs text-muted-foreground bg-black/40 border-b border-border">
 <tr>
 ...
 <div className="text-xs text-muted-foreground truncate max-w-[200px]">{type.description}</div>
 </div>
 </div>
 </td>
 ...
 <td className="px-6 py-4 text-slate-300">
 <Badge variant="outline" className="border-border bg-muted/50">{type._count?.rooms || 0} Rooms</Badge>
 </td>
 <td className="px-6 py-4 text-right">
 <div className="flex items-center justify-end gap-2">
 <Button variant="ghost" size="icon" onClick={() => openModal(type)} className="h-8 w-8 text-muted-foreground hover:text-white hover:bg-white/10">
 ...
 <div>
 <label className="text-xs font-medium text-muted-foreground tracking-wider mb-1.5 block">Name</label>
 <input
 type="text"
 value={formData.name}
 onChange={(e) => setFormData({ ...formData, name: e.target.value })}
 className="w-full px-3 py-2 bg-black/40 border border-border rounded-lg text-white placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/50 text-sm"
 required
 ...
 <div>
 <label className="text-xs font-medium text-muted-foreground tracking-wider mb-1.5 block">Base Rate ($)</label>
 <input
 type="number"
 step="0.01"
 min="0"
 ...
 <div>
 <label className="text-xs font-medium text-muted-foreground tracking-wider mb-1.5 block">Capacity</label>
 <input
 type="number"
 min="1"
 ...
 <div>
 <label className="text-xs font-medium text-muted-foreground tracking-wider mb-1.5 block">Description</label>
 <textarea
 value={formData.description}
 onChange={(e) => setFormData({ ...formData, description: e.target.value })}
 className="w-full px-3 py-2 bg-black/40 border border-border rounded-lg text-white placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/50 text-sm h-20 resize-none"
 placeholder="Room type description..."
 />
 </div>

 <div>
 <label className="text-xs font-medium text-muted-foreground tracking-wider mb-1.5 block">Amenities (comma separated)</label>
 <input
 type="text"
 ...
 <Button type="button" variant="ghost" onClick={() => setShowModal(false)} className="text-muted-foreground hover:text-white hover:bg-muted/50">
 Cancel
 </Button>
