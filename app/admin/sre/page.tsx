...
export default function SRECommandCenter() {
 ...
 <Card key={i} className="p-6 bg-card border-border rounded-[32px] flex items-center gap-5">
 <div className={cn(
 "p-4 rounded-lg border transition-colors",
 kpi.status === 'HEALTHY' ? "bg-emerald-500/10 border-border text-emerald-400" : "bg-rose-500/10 border-border text-rose-400"
 )}>
 ...
 <h3 className="text-xs font-bold text-muted-foreground tracking-[0.2em]">Infrastructure Topology</h3>
 </div>
 <Badge className="bg-muted/50 text-muted-foreground border-none px-3 py-1 text-xs">5 NODES ACTIVE</Badge>
 </div>
 ...
 <h3 className="text-xs font-bold text-muted-foreground tracking-[0.2em]">Operational Lineage</h3>
 </div>
 <Card className="bg-card border-border p-0 rounded-xl overflow-hidden">
 ...
 <span className="text-xs font-bold text-muted-foreground ">Streaming</span>
 </div>
 </div>
 </div>
 ...
 <Badge className={cn(
 "text-xs border-none px-2 py-0.5",
 ...
 <span className="text-xs text-muted-foreground font-bold">{entry.time}</span>
 </div>
 ))}
 </div>
 </Card>
 ...
 <Card className="bg-card border-border p-8 rounded-xl space-y-8">
 <div className="flex items-center gap-3">
 <div className="p-2 rounded-lg bg-primary/10 border border-primary/20 text-primary"><RefreshCw className="w-5 h-5" /></div>
 <h3 className="text-sm font-bold text-muted-foreground tracking-[0.2em]">Global Parity Map</h3>
 </div>
 ...
 <h4 className="text-xs font-bold text-muted-foreground tracking-[0.2em]">Critical Alerts</h4>
 <div className="p-4 rounded-lg bg-amber-500/5 border border-border space-y-2">
 <div className="flex items-center gap-2">
 <AlertTriangle className="w-3 h-3 text-amber-500" />
 <span className="text-xs font-bold text-amber-500 ">Rate Drift Detected</span>
 </div>
