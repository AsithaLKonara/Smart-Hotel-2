...
export default function AdminInventoryPage() {
 ...
 <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 ">Min Qty</th>
 ...
 {/* Adjust Stock Modal */}
 <Dialog.Root open={!!adjustModal} onOpenChange={(o: boolean) => !o && setAdjustModal(null)}>
 <Dialog.Portal>
 ...
 <button onClick={() => setAdjustModal(null)} className="text-muted-foreground hover:text-white transition-colors">
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 <div>
 <label className="text-xs text-white/60 font-bold tracking-wider mb-2 block">New Quantity ({adjustModal?.unit})</label>
 ...
 className="bg-[#1a1a24] border-border text-white text-lg font-bold" />
 </div>
 <div>
 <label className="text-xs text-white/60 font-bold tracking-wider mb-2 block">Location</label>
 <Input value={adjustForm.location} onChange={e => setAdjustForm({ ...adjustForm, location: e.target.value })}
 className="bg-[#1a1a24] border-border text-white" placeholder="e.g. Storeroom A" />
 </div>
 <div>
 <label className="text-xs text-white/60 font-bold tracking-wider mb-2 block">Reason</label>
 <Input value={adjustForm.reason} onChange={e => setAdjustForm({ ...adjustForm, reason: e.target.value })}
 className="bg-[#1a1a24] border-border text-white" placeholder="e.g. Manual Count, Spillage" />
 </div>
