...
export default function ResortPage() {
 ...
 <p className="text-muted-foreground">Manage Spa treatments, Golf tee times, and Cabana rentals.</p>
 </div>
 ...
 <Card key={facility.id} className="bg-[#1a1a1a] border-border text-white flex flex-col">
 ...
 <div className="text-xs bg-white/10 px-2 py-1 rounded font-bold text-slate-300">
 {facility.type}
 </div>
 </div>
 <CardContent className="p-0 flex-1 flex">
 {/* Services List */}
 <div className="w-1/3 border-r border-border p-4 bg-black/10">
 <h3 className="text-sm font-bold text-muted-foreground tracking-wider mb-3">Menu</h3>
 <div className="space-y-2">
 {(facility.services || []).map((svc: any) => (
 <div key={svc.id} className="bg-muted/50 p-2 rounded border border-border">
 ...
 <h3 className="text-sm font-bold text-muted-foreground tracking-wider mb-3 flex items-center gap-2">
 ...
 <div key={booking.id} className="flex items-center gap-4 bg-black p-3 rounded-lg border border-border">
 ...
 {facilities.length === 0 && (
 <div className="col-span-2 text-center p-12 text-muted-foreground border border-dashed border-border rounded-xl">
 ...
 <DialogContent className="bg-[#121212] border-border text-white max-w-lg rounded-lg p-6">
 ...
 className="w-full bg-muted/50 border border-border rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-emerald-500"
 required
 >
 {facilities.map(f => (
