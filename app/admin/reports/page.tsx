...
export default function ReportsDashboard() {
 ...
 <CardTitle className="text-indigo-900 flex items-center text-sm font-semibold tracking-wider">
 ...
 <CardHeader className="pb-2">
 <CardTitle className="text-emerald-900 flex items-center text-sm font-semibold tracking-wider">
 ...
 <CardHeader className="pb-2">
 <CardTitle className="text-blue-900 flex items-center text-sm font-semibold tracking-wider">
 ...
 <div className="text-xs text-emerald-700 font-semibold mt-1">Arrivals</div>
 </div>
 ...
 <div className="text-xs text-amber-700 font-semibold mt-1">Departures</div>
 </div>
 </CardContent>
 </Card>
 ...
 <div className="text-center text-muted-foreground py-4">No revenue data available for this month yet.</div>
 ) : (
