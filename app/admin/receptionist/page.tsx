...
export default function ReceptionistOperationsCenter() {
 ...
 <section>
 <div className="bg-muted/50 border border-border rounded-xl p-4 mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
 <div className="flex items-end gap-4">
 <div>
 <label className="text-xs text-white/60 mb-1 block">Check-in Date</label>
 <input type="date" className="bg-black/40 border border-border rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-primary" value={availabilityDates.checkIn} onChange={e => setAvailabilityDates({...availabilityDates, checkIn: e.target.value})} />
 </div>
 <div>
 <label className="text-xs text-white/60 mb-1 block">Check-out Date</label>
 <input type="date" className="bg-black/40 border border-border rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-primary" value={availabilityDates.checkOut} onChange={e => setAvailabilityDates({...availabilityDates, checkOut: e.target.value})} />
 </div>
 ...
 <Badge variant="outline" className="border-border text-emerald-400 bg-emerald-500/10 py-1.5 px-4 text-sm font-bold">
 ...
 <Button onClick={handleShiftClose} variant="destructive" className="bg-rose-500/20 text-rose-400 border border-border hover:bg-rose-500/40">
 ...
 <Badge variant="outline" className="text-xs border-border text-muted-foreground px-4 py-1">
