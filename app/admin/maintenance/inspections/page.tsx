...
export default function InspectionsPage() {
 ...
 <p className="text-muted-foreground">Historical ledger of technician work</p>
 </div>
 ...
 <label className="text-xs text-muted-foreground">Asset Inspected</label>
 ...
 <div>
 <label className="text-xs text-muted-foreground">Technician Name</label>
 <input required value={formData.technicianName} onChange={e=>setFormData({...formData, technicianName: e.target.value})} className="w-full p-2 rounded bg-black/50 border border-border mt-1" />
 </div>
 <div>
 ...
 <div className="col-span-2">
 <label className="text-xs text-muted-foreground">Inspection Notes</label>
 <textarea value={formData.notes} onChange={e=>setFormData({...formData, notes: e.target.value})} className="w-full p-2 rounded bg-black/50 border border-border mt-1 h-24" />
 </div>
 </div>
 ...
 <Card key={insp.id} className="bg-[#1a1a1a] border-border text-white">
 ...
 <p className="text-xs text-muted-foreground">{new Date(insp.inspectionDate).toLocaleString()}</p>
 </div>
 </div>
 </div>
 ...
 {insp.notes && (
 <p className="text-sm text-muted-foreground line-clamp-3 mb-4 bg-black/30 p-2 rounded border border-border">
 "{insp.notes}"
 </p>
 )}
 ...
 <p className="text-muted-foreground col-span-3 text-center py-12">No inspections logged.</p>
 )}
 </div>
 </div>
 )
