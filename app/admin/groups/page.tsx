...
export default async function GroupsPage() {
 ...
 <div className="bg-[#111] border border-border rounded-xl overflow-hidden shadow-sm">
 ...
 className="w-full bg-black/50 border border-border rounded-lg pl-10 pr-4 py-2 text-sm text-white placeholder-white/40 focus:outline-none focus:border-brand-purple transition-colors"
 />
 </div>
 <div className="flex gap-2 w-full sm:w-auto">
 <button className="flex-1 sm:flex-none px-3 py-2 bg-black/50 border border-border rounded-lg text-sm text-white hover:bg-muted/50 transition-colors">
 Active Blocks
 </button>
 <button className="flex-1 sm:flex-none px-3 py-2 bg-black/50 border border-border rounded-lg text-sm text-white/50 hover:text-white hover:bg-muted/50 transition-colors">
 Past Blocks
 </button>
 </div>
 </div>
 ...
 <thead>
 <tr className="bg-black/40 border-b border-border text-xs tracking-wider text-white/50">
 ...
 <tr key={group.id} className="hover:bg-muted/50 transition-colors group/row">
 <td className="p-4">
 ...
 <span className="text-xs text-muted-foreground">{group.pickedUpRooms} / {group.totalRooms} Picked</span>
 </td>
 <td className="p-4">
