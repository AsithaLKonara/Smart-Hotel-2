...
export default function MyBookingsPage() {
 ...
 switch (status) {
 case 'CONFIRMED':
 return 'bg-emerald-500/10 text-emerald-500 border-border'
 case 'CHECKED_IN':
 ...
 default:
 return 'bg-amber-500/10 text-amber-500 border-border'
 }
 }
 ...
 <Card key={booking.id} className="overflow-hidden border-border bg-card">
 ...
 <div>
 <p className="text-xs font-bold text-muted-foreground">Dates</p>
 ...
 <div>
 <p className="text-xs font-bold text-muted-foreground">Occupancy</p>
 ...
 variant="outline"
 size="sm"
 className="bg-muted/50 border-border rounded-xl text-xs font-bold px-6"
 onClick={() => {
 ...
 variant="outline"
 size="sm"
 className="border-border text-rose-500 hover:bg-rose-500/10 rounded-xl text-xs font-bold px-6"
 ...
 <Card className="w-full max-w-lg bg-card border-border rounded-xl overflow-hidden">
 ...
 <div>
 <p className="text-xs font-bold text-muted-foreground mb-1">Room</p>
 ...
 <div>
 <p className="text-xs font-bold text-muted-foreground mb-1">Booking ID</p>
 <p className="text-sm font-mono text-muted-foreground">{selectedBooking.id}</p>
 </div>
 <div>
 <p className="text-xs font-bold text-muted-foreground mb-1">Check-in</p>
 <p className="text-sm font-medium">{formatDate(selectedBooking.checkIn)}</p>
 </div>
 <div>
 <p className="text-xs font-bold text-muted-foreground mb-1">Check-out</p>
 <p className="text-sm font-medium">{formatDate(selectedBooking.checkOut)}</p>
 </div>
 </div>
 
 <div className="pt-6 border-t border-border">
 <p className="text-xs font-bold text-muted-foreground mb-2">Status Overview</p>
 ...
 <div className="pt-6 border-t border-border">
 <p className="text-xs font-bold text-muted-foreground mb-1">Special Requests</p>
 ...
 <Button
 variant="outline"
 className="bg-muted/50 border-border rounded-xl text-xs font-bold px-8"
