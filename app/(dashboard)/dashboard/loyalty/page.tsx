...
export default function LoyaltyPage() {
 ...
 <Card className={cn(
 "p-10 rounded-xl text-white relative overflow-hidden shadow-sm border-none",
 ...
 <Badge className="bg-white/20 backdrop-blur-md text-white border-white/20 text-xs py-1 px-4">
 ...
 <p className="text-xs font-bold opacity-60">Total Reward Points</p>
 </div>
 ...
 <h4 className="text-xs font-bold text-muted-foreground px-2">Elite Privileges</h4>
 ...
 benefit.active ? "bg-primary/5 border-primary/20 text-white" : "bg-muted/50 border-border text-muted-foreground"
 )}>
 <div className={cn(
 ...
 <h4 className="text-xs font-bold text-muted-foreground flex items-center gap-3">
 <History className="w-4 h-4" /> Points Activity
 </h4>
 <Button variant="ghost" className="text-xs font-bold text-primary hover:bg-primary/10">
 Download Statement
 </Button>
 </div>
 ...
 <div key={tx.id} className="p-8 flex items-center justify-between hover:bg-muted/30 transition-colors group">
 ...
 <p className="text-xs text-muted-foreground mt-1">{new Date(tx.createdAt).toLocaleDateString()} • {tx.type.toUpperCase()}</p>
 </div>
 </div>
 ...
 <p className="text-xs font-bold text-muted-foreground">Credits</p>
 </div>
 </div>
 )) : (
 <div className="p-32 text-center space-y-4">
 <Gift className="w-12 h-12 text-white/5 mx-auto" />
 <p className="text-xs text-muted-foreground font-bold ">Your rewards journey begins with your first stay.</p>
 </div>
 )}
 </div>
 </Card>
 ...
 <Card className="p-8 bg-primary/10 border-none rounded-xl flex items-center justify-between group cursor-pointer hover:scale-[1.02] transition-all shadow-sm">
 <div className="space-y-1">
 ...
 <Card className="p-8 bg-muted/50 border-border rounded-xl flex items-center justify-between group cursor-pointer hover:bg-white/10 transition-all">
 <div className="space-y-1">
 <h5 className="font-serif font-bold text-white text-lg">Gift Vouchers</h5>
 <p className="text-xs text-muted-foreground">Share the luxury</p>
 </div>
 <div className="w-12 h-12 rounded-full bg-muted/50 flex items-center justify-center text-white group-hover:bg-primary/20 group-hover:text-primary transition-all">
 <ChevronRight className="w-6 h-6" />
 </div>
 </Card>
 </div>
