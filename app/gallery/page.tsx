...
export default function GalleryPage() {
 ...
 className={`px-8 py-2 text-xs tracking-[0.2em] font-bold transition-all border rounded-lg ${
 ...
 <p className="text-luxury text-xs font-bold">{image.category}</p>
 ...
 <p className="text-luxury text-xs tracking-[0.4em] font-bold">{selectedImage.category}</p>
 ...
 onClick={() => setSelectedImage(null)}
 variant="outline" 
 className="border-white/20 text-white rounded-none px-10 h-14 text-xs font-bold hover:bg-white hover:text-midnight transition-all"
 >
 Close Gallery
 </Button>
 </div>
