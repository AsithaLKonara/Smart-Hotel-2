...
export default function TravelAgentPortal() {
 ...
 <Button variant="outline" className="border-white/20 hover:bg-muted/50 text-white" onClick={() => setLoggedIn(false)}>
 Sign Out
 </Button>
 </div>
 ...
 {/* Booking Form */}
 <Card className="md:col-span-2 bg-[#1a1a1a] border-border">
 <CardHeader>
 <CardTitle>Book Client Travel</CardTitle>
 </CardHeader>
 <CardContent className="flex flex-col gap-4">
 <div className="grid grid-cols-2 gap-4">
 <Input placeholder="Client First Name" value={firstName} onChange={(e) => setFirstName(e.target.value)} className="bg-muted/50 border-border text-white" />
 <Input placeholder="Client Last Name" value={lastName} onChange={(e) => setLastName(e.target.value)} className="bg-muted/50 border-border text-white" />
 </div>
 <div className="grid grid-cols-2 gap-4">
 <Input type="date" value={checkIn} onChange={(e) => setCheckIn(e.target.value)} className="bg-muted/50 border-border text-white" />
 <Input type="date" value={checkOut} onChange={(e) => setCheckOut(e.target.value)} className="bg-muted/50 border-border text-white" />
 </div>
 <Button 
 onClick={handleBook} 
