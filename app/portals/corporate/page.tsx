...
export default function CorporatePortal() {
 ...
 <CardContent className="flex flex-col gap-4">
 <Input placeholder="Employee Name" className="bg-muted/50 border-border text-white" />
 <div className="grid grid-cols-2 gap-4">
 <Input type="date" className="bg-muted/50 border-border text-white" />
 <Input type="date" className="bg-muted/50 border-border text-white" />
 </div>
 <Button 
 onClick={handleBook} 
 ...
 <div key={b.id} className="bg-[#1a1a1a] p-4 rounded-xl border border-border flex justify-between items-center">
 <div>
 ...
 <p className="text-xs text-muted-foreground">Corporate Rate Applied</p>
 </div>
 </div>
 ))
 )}
