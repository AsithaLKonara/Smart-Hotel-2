...
export default function OnboardingWizard() {
 ...
 <div className="w-full max-w-2xl bg-[#121118]/85 border border-white/[0.04] rounded-xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.6)] space-y-8 flex flex-col justify-between min-h-[550px] relative overflow-hidden">
 ...
 <span className="text-xs tracking-[0.25em] text-[#D4AF37] font-semibold">Quick Setup Wizard</span>
 ...
 <span className={`px-2 py-0.5 rounded ${step === 1 ? 'bg-[#D4AF37] text-[#09050D] font-bold' : 'bg-muted/50'}`}>1</span>
 <span>—</span>
 <span className={`px-2 py-0.5 rounded ${step === 2 ? 'bg-[#D4AF37] text-[#09050D] font-bold' : 'bg-muted/50'}`}>2</span>
 <span>—</span>
 <span className={`px-2 py-0.5 rounded ${step === 3 ? 'bg-[#D4AF37] text-[#09050D] font-bold' : 'bg-muted/50'}`}>3</span>
 </div>
 </div>
 ...
 <div className="bg-muted/30 border border-white/[0.02] p-4 rounded-xl text-left max-w-md mx-auto space-y-2 text-[11px] text-[#8E8C94]">
 <span className="font-semibold text-white tracking-wider block">First Steps Checklist:</span>
 ...
 className="px-6 py-3 rounded-xl text-xs font-semibold tracking-wider bg-gradient-to-r from-[#D4AF37] to-[#9C8259] text-[#09050D] hover:opacity-95"
 >
 ...
 <label className="text-xs font-semibold tracking-wider text-[#8E8C94]">Property Name</label>
 <input
 type="text"
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-semibold tracking-wider text-[#8E8C94]">Jurisdiction Region</label>
 <select
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-semibold tracking-wider text-[#8E8C94]">SaaS Pricing Tier</label>
 <select
 value={selectedPlan}
 ...
 <div className="space-y-5 text-left">
 <div className="space-y-1.5">
 <label className="text-xs font-semibold tracking-wider text-[#8E8C94]">Total Rooms to Import</label>
 ...
 <div className="p-4 rounded-xl bg-muted/30 border border-white/[0.03] space-y-2">
 <span className="text-xs font-semibold text-[#D4AF37] tracking-wider block">Bulk Roster Profiles:</span>
 <div className="grid grid-cols-2 gap-2 text-xs text-[#8E8C94]">
 ...
 <div className="space-y-5 text-left">
 <div className="space-y-1.5">
 <label className="text-xs font-semibold tracking-wider text-[#8E8C94]">Invite Team Members</label>
 <div className="flex gap-2">
 <input
 type="email"
 ...
 <span key={idx} className="px-2 py-1 text-xs font-mono text-white bg-[#D4AF37]/10 rounded border border-[#D4AF37]/20">
 {email}
 </span>
 ))}
 </div>
 ...
 <label className="flex items-start space-x-3 cursor-pointer text-xs p-3 rounded-xl bg-muted/30 border border-white/[0.03]">
 <input
 type="checkbox"
 ...
 <p className="text-xs text-[#8E8C94]">Populate system with test reservations, reviews, and housekeeping rosters.</p>
 </div>
 </label>
 </div>
 )}
 ...
 disabled={step === 1}
 className="px-4 py-2 rounded-xl text-xs font-bold tracking-wider text-[#8E8C94] hover:text-white disabled:opacity-30"
 >
 Back
 </button>
 <button
 onClick={handleNextStep}
 className="px-5 py-2.5 rounded-xl text-xs font-bold tracking-wider bg-gradient-to-r from-[#D4AF37] to-[#9C8259] text-[#09050D] hover:opacity-95"
 >
