...
export default function PrivacyPage() {
 ...
 <Link href="/" className="inline-flex items-center gap-2 mb-8 text-luxury text-xs font-bold hover:opacity-70 transition-opacity">
 ...
 <p className="text-xs text-luxury font-bold pt-4">Effective: {lastUpdated}</p>
 </div>
 </div>
 </section>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-[11px] font-bold text-midnight">
 <div>
