...
export default async function MobileHousekeeping() {
 ...
 {rooms.map((room: any) => (
 <div key={room.id} className="bg-[#1a1a1a] p-4 rounded-lg shadow-xl border border-border flex flex-col gap-4">
 <div className="flex justify-between items-start">
 <div>
 <span className="text-3xl font-bold">{room.number}</span>
