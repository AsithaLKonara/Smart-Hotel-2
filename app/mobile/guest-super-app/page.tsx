...
export default function GuestMobileSuperApp() {
 ...
 <div>
 <span className="text-xs text-[#D4AF37] font-semibold">{t.welcome}</span>
 ...
 <div className="bg-muted/30 border border-white/[0.03] p-3 rounded-xl flex justify-between items-center">
 ...
 checkedIn 
 ? 'bg-emerald-500/10 text-emerald-400 border border-border' 
 ...
 {/* Tab Body Renderings */}
 <div className="flex-1 bg-muted/30 border border-white/[0.02] p-4 rounded-lg flex flex-col justify-center min-h-[320px]">
 ...
 nfcPaired ? 'bg-[#D4AF37]/5' : 'bg-muted/50'
 }`}
 >
 {/* simulated lock icon */}
 ...
 <button
 onClick={() => setNfcPaired(!nfcPaired)}
 className="text-[11px] font-bold tracking-wider text-[#D4AF37] bg-[#D4AF37]/10 border border-[#D4AF37]/20 px-4 py-2 rounded-xl"
 >
 ...
 className="space-y-4"
 >
 <span className="text-xs tracking-wider text-[#8E8C94] font-medium block">Gastronomy Roster</span>
 ...
 <span className="text-xs text-[#8E8C94]">Truffle glaze, baby marrow</span>
 </div>
 ...
 <span className="text-xs text-[#8E8C94]">Blinis, traditional garnishes</span>
 </div>
 ...
 {diningOrdered ? (
 <p className="text-xs text-emerald-400 font-mono text-center p-3 border border-border rounded-xl bg-emerald-500/5">
 {t.orderSuccess}
 </p>
 ) : (
 <button
 onClick={() => setDiningOrdered(true)}
 className="w-full py-2.5 rounded-xl text-xs font-bold tracking-wider bg-gradient-to-r from-[#D4AF37] to-[#9C8259] text-[#09050D]"
 >
 Place Dinner Order
 </button>
 )}
 ...
 <span className="text-xs tracking-wider text-[#8E8C94] font-medium block">Front Gate Access</span>
 ...
 <div className="text-2xl font-mono font-bold text-white bg-black/40 py-2 rounded-lg border border-border">
 {passCode}
 </div>
 <p className="text-xs text-[#8E8C94] px-4 pt-2">Security has been notified. The driver will be directed to your floor.</p>
 </div>
 ) : (
 <div className="space-y-3">
 <select 
 ...
 className="w-full py-2.5 rounded-xl text-xs font-bold tracking-wider bg-gradient-to-r from-[#D4AF37] to-[#9C8259] text-[#09050D] disabled:opacity-50"
 >
 ...
 {/* Footer branding */}
 <div className="text-center">
 <span className="text-xs tracking-[0.25em] text-[#8E8C94]/60 font-semibold font-serif">
