...
function ErrorState({ title, message }: { title: string; message: string }) {
 ...
 <div className="w-16 h-16 bg-muted/50 border border-border rounded-lg flex items-center justify-center mx-auto">
 ...
 <Link href="/rooms">
 <Button className="bg-primary/10 text-white rounded-xl px-8 h-12 text-xs font-bold border-none shadow-sm">
 <ArrowLeft className="w-4 h-4 mr-2" />Browse Rooms
 </Button>
 </Link>
 <Link href="/">
 <Button variant="outline" className="border-white/20 text-white rounded-xl px-8 h-12 text-xs font-bold hover:bg-white/10">
 Homepage
 </Button>
 </Link>
 </div>
...
export default async function RoomDetailPage({ params }: RoomDetailPageProps) {
 ...
 <Link href="/rooms" className="relative z-50 w-fit inline-flex items-center gap-2 mb-4 text-white/50 hover:text-primary transition-colors text-sm font-bold">
 <ArrowLeft className="w-4 h-4" />Back to Rooms
 </Link>
 <div className="flex items-end justify-between gap-4">
 <div className="space-y-2">
 <span className="text-primary text-xs font-bold">{serializedRoom.type}</span>
 ...
 <div key={i} className="text-center space-y-2 p-4 bg-muted/50 rounded-xl border border-border">
 <spec.icon className="w-5 h-5 text-primary mx-auto" />
 <p className="text-xs text-muted-foreground font-bold">{spec.label}</p>
 ...
 : Star
 return (
 <div key={idx} className="flex items-center gap-3 p-3 bg-muted/50 rounded-xl border border-border hover:border-primary/20 transition-colors">
 ...
 <p className="text-xs text-muted-foreground font-bold">{policy.label}</p>
 ...
 <div className="bg-muted/50 backdrop-blur-xl border border-border rounded-lg p-8 sticky top-28 space-y-8">
 ...
 <p className="text-muted-foreground text-xs font-bold">Per Night</p>
 </div>
 ...
 <Button className="w-full bg-primary/10 text-white h-14 rounded-xl tracking-[0.2em] text-xs font-bold border-none shadow-sm hover:opacity-90 transition-opacity">
 Reserve This Suite
 </Button>
 </Link>
 ...
 <Link href="/contact" className="text-xs text-primary hover:underline font-bold">
