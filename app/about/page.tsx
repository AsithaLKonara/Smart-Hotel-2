...
export default async function AboutPage() {
 ...
 <h4 className="text-luxury text-xs font-bold">Established in {founded}</h4>
 ...
 <div className="flex items-center gap-8 py-8 border-t border-border">
 <div>
 <p className="text-3xl font-serif font-bold text-white">30+</p>
 <p className="text-xs text-white/50 font-bold">Years of Excellence</p>
 </div>
 <div className="w-px h-12 bg-white/10" />
 <div>
 <p className="text-3xl font-serif font-bold text-white">500+</p>
 <p className="text-xs text-white/50 font-bold">World-Class Awards</p>
 </div>
 </div>
 </div>
 ...
 <h4 className="text-luxury text-xs font-bold">Our Philosophy</h4>
 ...
 <div key={i} className="bg-muted/50 border border-border p-10 text-center space-y-6 shadow-sm hover:-translate-y-2 transition-all duration-500 rounded-lg">
 ...
 <h4 className="text-luxury text-xs font-bold">Our Journey</h4>
 ...
 {/* Team Section */}
 <section className="py-24 lg:py-32 bg-transparent border-t border-border text-white">
 <div className="container mx-auto px-4">
 <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
 <div className="space-y-4">
 <h4 className="text-luxury text-xs font-bold">The Artisans</h4>
 ...
 <div className="relative aspect-[3/4] overflow-hidden rounded-lg grayscale group-hover:grayscale-0 transition-all duration-700">
 <Image 
 ...
 <p className="text-luxury text-xs tracking-[0.2em] font-bold">{member.position}</p>
