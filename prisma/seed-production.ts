import { Prisma, PrismaClient, UserRole, RoomStatus, BookingStatus, PaymentStatus, TaskType, TaskPriority, TaskStatus, InventoryStatus, GalleryCategory, FoodCategory, OrderStatus, PromotionType, EmailStatus, NotificationType } from '@prisma/client'
