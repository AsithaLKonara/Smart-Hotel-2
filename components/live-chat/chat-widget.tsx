...
const ReactMarkdown = dynamic(() => import("react-markdown"), { 
 ssr: false,
 loading: () => <div className="animate-pulse bg-muted/50 h-20 w-full" />
});
...
export function ChatWidget({
 ...
 <span className="text-xs font-bold tracking-[0.2em] text-primary/60">Sanctuary Sync Active</span>
 </div>
 <span className="text-xs font-mono text-primary/30 ">v5.0-Neural</span>
 </div>

 {/* Header */}
 <div className="p-6 flex justify-between items-center bg-gradient-to-b from-primary/10 to-transparent">
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center text-white shadow-sm">
 <Sparkles size={24} className="relative z-10" />
 </div>
 <div>
 <h3 className="font-bold text-white text-base leading-tight ">Sanctuary Concierge</h3>
 <div className="flex items-center gap-1.5 mt-0.5">
 <div className="w-1 h-1 rounded-full bg-primary" />
 <span className="text-xs text-primary/50 font-bold ">Neural Cluster #A1</span>
 </div>
 </div>
 </div>
 <div className="flex gap-2">
 <button aria-label="Minimize chat" onClick={() => setIsOpen(false)} className="p-2.5 hover:bg-white/10 rounded-lg transition-all text-muted-foreground hover:text-white">
 <Minus size={20} />
 </button>
 <button aria-label="Close chat" onClick={() => setIsOpen(false)} className="p-2.5 hover:bg-white/10 rounded-lg transition-all text-muted-foreground hover:text-white">
 <X size={20} />
 </button>
 </div>
 </div>
 ...
 h1: (props: any) => <h1 className="text-lg font-bold tracking-tight mb-2 text-blue-400" {...props} />,
 h2: (props: any) => <h2 className="text-base font-bold tracking-tight mb-2 text-blue-400" {...props} />,
 code: (props: any) => <code className="bg-white/10 px-1.5 py-0.5 rounded text-xs font-mono text-blue-200" {...props} />,
 pre: (props: any) => <pre className="bg-muted/50 p-3 rounded-xl overflow-x-auto text-[13px] font-mono mb-2 border border-border" {...props} />,
 }}
 >
 {m.text}
 </ReactMarkdown>
 ...
 className="text-xs font-bold px-4 py-2 rounded-full bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20 transition-all active:scale-95"
 >
 {s}
 </button>
 ))}
 ...
 <div className="bg-primary/10 px-5 py-3 rounded-lg flex gap-1.5 items-center">
 ...
 <div className="relative flex items-center gap-3 bg-white/[0.05] rounded-[28px] p-2 pr-2.5 shadow-sm focus-within:bg-white/[0.1] transition-all group">
 <input
 ...
 className="w-12 h-12 bg-primary/10 text-white rounded-[22px] hover:scale-105 active:scale-95 transition-all disabled:opacity-20 disabled:scale-100 flex items-center justify-center shadow-sm"
 >
 <Send size={18} />
 </button>
 </div>
 <div className="mt-4 flex justify-between items-center opacity-30 text-xs font-bold tracking-[0.4em] text-blue-200">
 <div className="flex items-center gap-2">
 ...
 className="w-16 h-16 bg-primary/10 text-white rounded-[24px] shadow-sm flex items-center justify-center group relative overflow-hidden"
 >
