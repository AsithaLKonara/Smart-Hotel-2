...
export default function OrderFeed({ refreshTrigger }: { refreshTrigger: number }) {
 ...
 <CardTitle className="text-sm font-medium text-purple-100 tracking-wider flex justify-between items-center">
 ...
 <div 
 className={`text-xs px-2 py-1 rounded-full border cursor-pointer font-bold ${STATUS_COLORS[order.status] || STATUS_COLORS.PENDING}`}
