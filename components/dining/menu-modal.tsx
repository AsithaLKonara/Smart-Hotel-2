...
export function MenuModal({ isOpen, onClose, venueName }: MenuModalProps) {
 ...
 <DialogContent className="bg-card border-border text-white max-w-2xl rounded-[32px] max-h-[80vh] overflow-y-auto">
 <DialogHeader>
 ...
 <p className="text-muted-foreground">The menu is being updated. Please check back soon.</p>
 </div>
 ) : (
 ...
 <h3 className="text-xs font-bold text-primary">{category}</h3>
 ...
 {!item.available && (
 <Badge variant="outline" className="text-xs border-red-500/20 text-red-500 bg-red-500/5">Temporarily Unavailable</Badge>
 )}
 </div>
 </div>
 ))}
 ...
 <div className="mt-8 p-4 bg-muted/50 border border-border rounded-lg flex items-start gap-3">
