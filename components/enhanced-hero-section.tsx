...
export default function EnhancedHeroSection() {
 ...
 className="flex items-center justify-center space-x-4 text-luxury text-xs sm:text-xs font-semibold"
 >
 ...
 <Button className="w-full sm:w-auto bg-primary/10 hover:scale-[1.02] active:scale-[0.98] text-white px-12 h-14 rounded-xl text-xs font-bold border-none shadow-sm transition-all">
 Check Availability
 </Button>
 </Link>
 <Link href="/rooms" className="w-full sm:w-auto">
 <Button variant="outline" className="w-full sm:w-auto border-white/20 text-white rounded-xl px-12 h-14 text-xs font-bold hover:bg-white/10 transition-all backdrop-blur-md">
 Explore Suites
 </Button>
 </Link>
 </motion.div>
