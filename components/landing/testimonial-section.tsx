...
export function TestimonialSection() {
 ...
 return (
 <section className="py-24 lg:py-32 bg-black/45 border-y border-border overflow-hidden relative">
 <div className="absolute inset-0 bg-gradient-to-b from-primary/5 via-transparent to-primary/5 pointer-events-none" />
 
 <div className="container mx-auto px-4 relative">
 <div className="text-center space-y-4 mb-20">
 <h4 className="text-primary text-xs font-bold">Guest Voices</h4>
 ...
 <div className="relative w-20 h-20 rounded-full overflow-hidden border-2 border-primary/20 p-1 bg-muted/50 backdrop-blur-md">
 <Image 
 ...
 <h5 className="text-white font-bold text-sm">{defaultTestimonials[activeIndex].name}</h5>
 <p className="text-primary text-xs tracking-[0.2em] font-bold">{defaultTestimonials[activeIndex].role}</p>
 </div>
 </div>
 </motion.div>
 </AnimatePresence>
 ...
 <button 
 onClick={prev}
 className="w-12 h-12 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/50 hover:bg-primary/5 transition-all"
 >
