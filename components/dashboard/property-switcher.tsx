...
export function PropertySwitcher() {
 ...
 if (isLoading) {
 return (
 <div className="flex flex-col gap-1 px-3 py-2 rounded-md border border-border bg-black/50 justify-center items-center h-[58px]">
 ...
 return (
 <div className="flex flex-col gap-1 px-3 py-2 rounded-md hover:bg-muted/50 transition-colors border border-border bg-black/50">
 <div className="flex items-center gap-2 mb-1 justify-between">
 <div className="flex items-center gap-2">
 <Building2 size={14} className="text-brand-purple" />
 <span className="text-xs font-semibold text-white/50 tracking-wider">Property</span>
 </div>
