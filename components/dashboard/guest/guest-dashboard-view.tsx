...
export function GuestDashboardView({ session }: GuestDashboardViewProps) {
 ...
 <Card className="p-10 bg-card border-border rounded-xl space-y-6">
 <div className="space-y-1">
 <p className="text-xs font-bold text-muted-foreground ">Resort Connection</p>
 ...
 <p className="text-xs text-muted-foreground font-bold">Level 5 Master Sommelier</p>
 </div>
 </div>
 <Button className="w-full h-14 bg-muted/50 hover:bg-white/10 border border-border rounded-lg text-xs font-bold ">
 Message Concierge
 </Button>
 </Card>
 </div>
