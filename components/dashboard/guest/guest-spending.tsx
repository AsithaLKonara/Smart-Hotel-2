...
export function GuestSpending() {
 ...
 return (
 <Card className="p-10 bg-card border-border rounded-xl space-y-8 relative overflow-hidden group">
 ...
 <div className="p-3 rounded-lg bg-white/[0.03] border border-border text-muted-foreground">
 <Receipt className="w-6 h-6" />
 </div>
 <div>
 <h4 className="text-lg font-bold text-white tracking-tight">Stay Folio</h4>
 <p className="text-xs text-muted-foreground font-medium">Real-time expenditure tracking</p>
 </div>
 </div>
 <div className="text-right">
 <p className="text-xs font-bold text-muted-foreground ">Total Spending</p>
 ...
 <p className="text-xs text-muted-foreground font-bold ">{tx.category}</p>
 </div>
 </div>
 ...
 <p className="text-xs font-bold text-muted-foreground mb-1">Pending</p>
 <p className="text-xl font-bold text-white">${summary.pendingPayments.toFixed(2)}</p>
 </div>
 <button className="flex items-center justify-center gap-2 p-6 bg-primary/10 hover:bg-primary/20 border border-primary/20 rounded-xl text-xs font-bold text-primary transition-all">
