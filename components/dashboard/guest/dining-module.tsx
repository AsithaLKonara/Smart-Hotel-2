...
export function DiningModule({ roomNumber = "101", guestInfo }: DiningModuleProps) {
 ...
 {/* Module Navigation */}
 <div className="flex flex-col md:flex-row gap-6 items-center justify-between bg-muted/50 border border-border p-4 rounded-[32px] backdrop-blur-xl">
 <div className="flex gap-2 p-1 bg-black/40 rounded-lg border border-border w-full md:w-auto">
 <button
 onClick={() => setActiveTab('room-service')}
 className={cn(
 "flex-1 md:w-48 px-6 py-3 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-3",
 ...
 <div className="flex items-center gap-6 px-6 py-2 border-l border-border hidden md:flex">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 rounded-full bg-emerald-500/10 flex items-center justify-center border border-border">
 <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
 </div>
 <div>
 <p className="text-xs font-bold text-muted-foreground">Kitchen Status</p>
 ...
 <div>
 <p className="text-xs font-bold text-muted-foreground">Current Delay</p>
 <p className="text-xs font-bold text-white">~15-20 Mins</p>
 </div>
 </div>
 </div>
 </div>
 ...
 >
 {venues.map((venue) => (
 <Card key={venue.id} className="bg-card border-border rounded-xl overflow-hidden group hover:border-primary/30 transition-all duration-500 shadow-sm relative">
 <div className="absolute top-6 right-6 z-20">
 <div className="bg-black/60 backdrop-blur-md border border-border rounded-full px-4 py-1.5 flex items-center gap-2">
 <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]" />
 <span className="text-xs font-bold text-white/80">Available Today</span>
 </div>
 </div>
 ...
 <p className="text-xs font-bold text-primary ">{venue.subtitle}</p>
 ...
 <Badge key={i} variant="outline" className="border-border bg-muted/50 text-muted-foreground text-xs px-3 py-1">
 {tag}
 </Badge>
 ))}
 </div>
 ...
 <Clock className="w-4 h-4 text-primary" />
 <div>
 <p className="text-xs text-muted-foreground font-bold">Service Hours</p>
 ...
 className="h-14 bg-primary hover:bg-primary/90 text-white rounded-lg text-xs font-bold shadow-sm transition-all active:scale-95"
 >
 Reserve Table
 </Button>
 <Button 
 ...
 variant="outline" 
 className="h-14 border-border bg-muted/50 hover:bg-white/10 text-white rounded-lg text-xs font-bold transition-all"
 >
 View Menu
 </Button>
 </div>
 ...
 <Card className="lg:col-span-2 bg-gradient-to-br from-primary/10 via-[#0c0c0c] to-[#0c0c0c] border-primary/20 rounded-xl p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group">
 ...
 <span className="text-xs font-bold text-primary">Private Collection</span>
 </div>
 <h2 className="text-3xl md:text-4xl font-serif font-bold text-white tracking-tight">The Sommelier's Reserve</h2>
 <p className="text-sm text-muted-foreground leading-relaxed">Experience our exclusive vault of vintage selections and limited-release distillates. Personal tastings available upon request.</p>
 </div>
 <Button className="relative z-10 h-16 px-10 bg-white text-black hover:bg-white/90 rounded-lg text-xs font-bold tracking-[0.2em] shadow-sm transition-all active:scale-95">
 Book Experience
 </Button>
 </Card>
 </motion.div>
