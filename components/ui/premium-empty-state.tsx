...
export const PremiumEmptyState = forwardRef<HTMLDivElement, PremiumEmptyStateProps>(({
 ...
 className={cn(
 "flex flex-col items-center justify-center text-center p-12 md:p-20 rounded-[48px] border border-border bg-card relative overflow-hidden group",
 className
 )}
 >
 ...
 <div className="absolute inset-0 bg-white/[0.03] border border-border rounded-xl rotate-12 group-hover:rotate-45 transition-transform duration-700" />
 <div className="absolute inset-0 bg-white/[0.03] border border-border rounded-xl -rotate-12 group-hover:-rotate-12 transition-transform duration-700" />
 <div className="relative p-6 bg-card border border-border rounded-lg shadow-sm">
 ...
 <button 
 onClick={onAction}
 className="mt-4 px-8 py-4 bg-muted/50 hover:bg-white/10 border border-border rounded-lg text-xs font-bold tracking-[0.2em] text-muted-foreground hover:text-white transition-all shadow-xl"
 >
 {actionLabel}
 </button>
 )}
