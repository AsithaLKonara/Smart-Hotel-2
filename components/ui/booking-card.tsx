...
export function BookingCard({ 
 ...
 className={cn(
 "group bg-white rounded-lg overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300",
 className
 )}
 >
 {/* Image Container */}
 ...
 index === currentImageIndex ? "bg-white" : "bg-muted/500"
 )}
 animate={{
