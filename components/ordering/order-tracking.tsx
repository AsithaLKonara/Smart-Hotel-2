...
export function OrderTracking({ orderId, onOrderComplete, onNewOrder }: OrderTrackingProps) {
 ...
 className="bg-[#121212] border border-border rounded-lg p-4 shadow-sm max-w-sm"
 >
 ...
 <Card className="bg-card border-border p-10 rounded-xl shadow-sm relative overflow-hidden">
 ...
 <div className={cn("w-20 h-20 rounded-xl flex items-center justify-center transition-all group-hover:scale-110", currentStatusConfig.bgColor)}>
 ...
 <p className="text-muted-foreground text-sm mt-1">{currentStatusConfig.description}</p>
 </div>
 </div>
 
 {order.estimatedTime && order.status !== 'DELIVERED' && order.status !== 'CANCELLED' && (
 <div className="text-right p-6 bg-muted/50 rounded-xl border border-border">
 <div className="text-4xl font-serif font-bold text-primary">{order.estimatedTime}</div>
 <div className="text-xs text-muted-foreground font-bold mt-1">minutes</div>
 </div>
 )}
 </div>
 ...
 <div className="w-10 h-10 rounded-full bg-muted/50 flex items-center justify-center text-xs font-bold text-muted-foreground">
 ×{item.quantity}
 </div>
 </div>
 ))}
 ...
 <span className="text-xs font-bold text-muted-foreground">Total Billable Amount</span>
 ...
 <Card className="bg-primary/5 border-primary/20 p-8 rounded-xl space-y-6">
 <div className="space-y-2">
 <h4 className="font-bold text-white">Need Assistance?</h4>
 <p className="text-xs text-muted-foreground leading-relaxed">Our concierge is standing by to assist with your order or any special dietary requirements.</p>
 </div>
 ...
 <p className="text-xs text-muted-foreground font-bold">Ext. 1234</p>
 </div>
 </div>
 <Button className="w-full h-12 bg-muted/50 hover:bg-white/10 border border-border text-white rounded-xl text-xs font-bold transition-all">
 ...
 variant="outline" 
 className="w-full h-16 border-border bg-card text-white rounded-xl font-bold text-xs hover:bg-muted/50 transition-all shadow-sm"
 >
 Return to Dining
 </Button>
 </div>
