...
export default function HotelFooter() {
 ...
 <div className="relative z-10 p-8 text-center text-muted-foreground text-sm font-bold">Loading...</div>
 </footer>
 )
 }
 ...
 <p className="text-xs text-primary font-bold">{contact.tagline || 'Grand Palace'}</p>
 </div>
 ...
 className="w-9 h-9 bg-muted/50 hover:bg-primary/20 border border-border hover:border-primary/30 rounded-xl flex items-center justify-center text-muted-foreground hover:text-primary transition-all duration-300"
 ...
 {/* Quick Links */}
 <div className="space-y-6">
 <h4 className="text-xs font-bold text-primary">Quick Links</h4>
 ...
 <li key={index}>
 <Link href={link.url} className="text-muted-foreground hover:text-primary text-sm font-light transition-colors duration-300 hover:tracking-wider">
 {link.label}
 </Link>
 </li>
 ))}
 ...
 {/* Services */}
 <div className="space-y-6">
 <h4 className="text-xs font-bold text-primary">Services</h4>
 <ul className="space-y-3">
 ...
 <span className="text-muted-foreground text-sm font-light">{link.label}</span>
 )}
 </li>
 ))}
 </ul>
 ...
 {/* Contact Info */}
 <div className="space-y-6">
 <h4 className="text-xs font-bold text-primary">Contact</h4>
 <div className="space-y-4">
 <div className="flex items-start space-x-3 group">
 <MapPin className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
 <p className="text-muted-foreground text-sm font-light leading-relaxed group-hover:text-white/60 transition-colors">{contact.address}</p>
 </div>
 <div className="flex items-center space-x-3 group">
 <Phone className="w-4 h-4 text-primary flex-shrink-0" />
 <p className="text-muted-foreground text-sm font-light group-hover:text-white/60 transition-colors">{contact.phone}</p>
 </div>
 <div className="flex items-center space-x-3 group">
 <Mail className="w-4 h-4 text-primary flex-shrink-0" />
 <p className="text-muted-foreground text-sm font-light group-hover:text-white/60 transition-colors">{contact.email}</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <Link key={index} href={link.url} className="text-muted-foreground hover:text-primary text-xs font-light transition-colors tracking-wider">
 {link.label}
 </Link>
 ))}
 <Link href="/contact" className="text-muted-foreground hover:text-primary text-xs font-light transition-colors tracking-wider">
 Contact Us
 </Link>
 </div>
 </div>
